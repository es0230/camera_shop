        ...
        <div className="modal__wrapper">
          ...
          <div className="modal__content">
            ...
            <div className="modal__buttons">
              <button data-testid="backToShoppingButton" className="btn btn--purple modal__btn modal__btn--fit-width" type="button" onClick={handleBackToShoppingClick}>Вернуться к покупкам
              </button>
            </div>
