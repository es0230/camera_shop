...
import { selectCurrentProduct, selectCurrentReviews, selectCurrentSimilarProducts, selectIsDataLoaded } from '../../store/app-data/selectors';
...
function Product(): JSX.Element {
  ...
  if (currentProduct !== null && !isDataLoaded) {
    return (
